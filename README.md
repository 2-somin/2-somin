...
- 🎓 **서울과학기술대학교** 도예학과 / 금속공예학과 부전공 (2018 – 2024)
- 💼 스타트업 **프로덕트 디자인 인턴** 6개월 근무
- 🎨 현재 **UI/UX 디자인**을 공부하며 프로덕트 디자이너로 취업 준비중
- 📫 **sm990650@gmail.com**
...
도예학과에서 조형의 원리와 미적 감각을 익혔고, 개인/팀 내에서 디자이너로써의 역할을 수행하며 프로덕트를 공부했습니다.
스타트업 디자인 인턴을 통해 실제 프로덕트 디자인 프로세스를 배웠습니다.

손으로 형태를 만드는 도예처럼, 
사용자가 자연스럽게 쓸 수 있는 인터페이스를 만드는 데 관심이 많습니다.

---

<div align="center">

![GitHub Stats](https://github-readme-stats.vercel.app/api?username=2-somin&show_icons=true&theme=calm&hide_border=true&locale=kr)
